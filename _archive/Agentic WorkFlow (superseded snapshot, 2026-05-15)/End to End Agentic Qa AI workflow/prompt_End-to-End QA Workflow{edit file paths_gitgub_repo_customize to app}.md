...
story to committed automated teyt scripts.
...
Based on the user syory SCRUM-101 that we just reviewed, use the playwright-test-planner
agent to:
...
Nowl.I need to perform manual exploratory testing using Playwright MCP browser tools.
...
- Which acceptance crituia are covered
...
Git Repository URL: https://github.com/ravikaanthe/jAgentE2EQAWorkflow-Playwright.git
